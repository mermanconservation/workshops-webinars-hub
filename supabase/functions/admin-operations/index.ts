...
serve(async (req) => {
  ...
  try {
    ...
    const allowedTables = ['workshops', 'presenters', 'company_settings', 'workshop_videos', 'workshop_materials', 'workshop_participants', 'certificate_verifications', 'workshop_presenters', 'workshop_lessons', 'courses', 'course_quizzes'];
